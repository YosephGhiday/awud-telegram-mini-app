      ...
      {isSpinner && (
        <div className="fixed inset-0 bg-black bg-opacity-35 z-[10002] w-full flex items-center justify-center">
          ...
          <button
            disabled
            type="button"
            className="justify-center h-20 w-20 text-sm font-medium bg-white/50 rounded-xl shadow-sm focus:z-10 focus:ring-4 focus:outline-none focus:ring-primary focus:text-primary dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 inline-flex items-center"
          >
            <svg
              aria-hidden="true"
              role="status"
