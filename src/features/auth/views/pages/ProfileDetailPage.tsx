...
export default function ProfileDetailPage() {
  ...
  return (
    <div className="w-full h-screen overflow-y-scroll bg-gray-100/50 max-w-[500px] flex flex-col px-10 py-15 gap-2 justify-start items-center">
      ...
      <span className="w-full flex flex-col items-center justify-center my-10">
        <User className="w-30 h-30 p-10 rounded-full border text-textPrimary bg-gray-100/50" />
